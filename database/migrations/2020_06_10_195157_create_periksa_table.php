...
class CreatePeriksaTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('periksa', function (Blueprint $table) {
            ...
            $table->dateTime('tgl_diperiksa')->nullable()->comment('tanggal pasien diperiksa oleh dokter');
            $table->unsignedInteger('f_status')->default(1)->comment('1:draft, 2:menunggu diperiksa, 3:sedang diperiksa oleh dokter, 3:selesai diperiksa, 4:menunggu pembayaran, 5:belum lunas, 6:lunas');
            ...
            $table->unsignedInteger('updated_by')->default(0)->comment('id users, [semua roles bisa]');
